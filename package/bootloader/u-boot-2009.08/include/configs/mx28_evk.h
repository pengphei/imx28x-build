...
#define CONFIG_ZERO_BOOTDELAY_CHECK   // Modify by zhangzhanwei
#define CONFIG_BOOTDELAY	0
#define CONFIG_BOOTFILE		"uImage"
//#define CONFIG_BOOTARGS		"console=ttyAM0,115200n8 "	/* modify by zhuguojun		*/
#define CONFIG_BOOTCOMMAND	"run nand_boot"
//#define CONFIG_LOADADDR		0x42000000
#define CONFIG_LOADADDR		0x41600000	/* modify by zhuguojun 使用64M的DDRAM后，必须退回10M地址才能写入大于32M的固件
...
#define CONFIG_DISCOVER_PHY		  //modify by hak
#define CONFIG_FEC0_PHY_ADDR		-1//modify by hak
...
#define CONFIG_IPADDR			192.168.1.87				//modefy by hak
#define CONFIG_SERVERIP			192.168.1.95				//modefy by hak
